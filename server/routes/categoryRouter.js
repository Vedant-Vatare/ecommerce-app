...
import { validateCreateCategory, validateUpdateCategory } from "../middlewares/categoryValidation.js";
import { createCategory, deleteCategory, getAllCategories, updateCategory } from "../controllers/categoryController.js";

const router = Router();

router.post("/create", authenticateAdmin, validateCreateCategory, asyncHandler(createCategory));
